...
class Info:
    ...
    def request_parse(self):
        ...
        self.comment = self.__data['comment']
        self.flag = self.__data['flag']
        self.request_type = self.__data['request_type']
        ...
        self.__server.dispatch_event(
            LiteralEvent('cool_q_api.on_qq_apply'),
            (self, self.__bot,)
        )
    ...
    def message_parse(self):
        ...
        self.source_sub_type = self.__data['sub_type']
        if isinstance(self.__data['message'], str):
            self.raw_content = self.__data['message']
        elif isinstance(self.__data['message'], list) \
            and isinstance(self.__data['message'][0], dict) \
            and "data" in self.__data['message'][0]: # NQTT
            self.raw_content = self.__data['message'][0].get("data").get("text", "A")
        self.content_parse()
